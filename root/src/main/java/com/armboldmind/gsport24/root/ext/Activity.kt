package com.armboldmind.gsport24.root.ext
...
import com.armboldmind.gsport24.root.R
...
fun AppCompatActivity.withFullScreen() {
    window.apply {
        decorView.systemUiVisibility = if (Build.VERSION.SDK_INT > 27) {
            navigationBarColor = ContextCompat.getColor(this@withFullScreen, android.R.color.white)
