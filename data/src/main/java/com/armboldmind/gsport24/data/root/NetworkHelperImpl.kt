...
import com.armboldmind.gsport24.data.model.requestModels.PaginationRequestModel
import com.armboldmind.gsport24.data.model.responseModels.root.PaginationResponseModel
import com.armboldmind.gsport24.data.model.responseModels.root.Response
import com.armboldmind.gsport24.root.di.ApplicationContext
...
constructor(
    ...
    private val defaultInternalErrorMessage: String by lazy { context.getString(com.armboldmind.gsport24.data.R.string.default_internal_error_message) }
    private val defaultNetworkErrorMessage: String by lazy { context.getString(com.armboldmind.gsport24.data.R.string.default_network_error_message) }
