...
import com.armboldmind.gsport24.databinding.FragmentPersonalInfoBinding
import com.armboldmind.gsport24.mvvm.ui.BaseFragment
import com.armboldmind.gsport24.mvvm.ui.TitleAdapter
import com.armboldmind.gsport24.root.ext.convertFrom
import com.armboldmind.gsport24.root.ext.convertTo
import com.armboldmind.gsport24.root.ext.toServerDate
import com.armboldmind.gsport24.root.utils.DatePatterns
import com.armboldmind.gsport24.shared.DatePickerDialog
import com.armboldmind.gsport24.shared.enums.GenderEnum
import com.armboldmind.gsport24.shared.ext.validationError
import java.util.*
...
class PersonalInfoFragment : BaseFragment<FragmentPersonalInfoBinding>() {
	...
	private fun showDatePicker(block : (Date) -> Unit) {
		...
		dialog.datePicker.maxDate = Calendar.getInstance().apply {
			set(current[Calendar.YEAR] - 21, current[Calendar.MONTH], current[Calendar.DAY_OF_MONTH], 0, 0)
		}.timeInMillis
		dialog.show()
	}
